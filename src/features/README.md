...
The key difference between preprocessors and processors is each 'side' in PixCrunch can process differently, whereas a preprocessor happens to both sides.
